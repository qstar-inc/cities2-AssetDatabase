...
async function processAssetPanelUIData(d, containers) {
  ...
  data_Vehicles = {
    Car_Size: d.Car_Size,
    Car_Energy: d.Car_Energy,
    Car_MaxSpeed: d.Car_MaxSpeed,
    Car_Acceleration: d.Car_Acceleration,
    Car_Braking: d.Car_Braking,
    Car_Turning: d.Car_Turning,
    Car_Stiffness: d.Car_Stiffness,
    PersonalCar_PassengerCap: d.PersonalCar_PassengerCap,
    PersonalCar_BaggageCap: d.PersonalCar_BaggageCap,
    PersonalCar_CostToDrive: d.PersonalCar_CostToDrive,
    PersonalCar_Probability: d.PersonalCar_Probability,
    Cargo_Cap: d.Cargo_Cap,
    Cargo_MaxResCount: d.Cargo_MaxResCount,
    Cargo_Maintenance: d.Cargo_Maintenance,
    Cargo_Resources: d.Cargo_Resources,
    FireEngine_ExtRate: d.FireEngine_ExtRate,
    FireEngine_ExtSpread: d.FireEngine_ExtSpread,
    FireEngine_ExtCap: d.FireEngine_ExtCap,
    FireEngine_ClearDuration: d.FireEngine_ClearDuration,
    PublicTransport_Type: d.PublicTransport_Type,
    PublicTransport_PassengerCap: d.PublicTransport_PassengerCap,
    PublicTransport_Purposes: d.PublicTransport_Purposes,
    PublicTransport_Maintenance: d.PublicTransport_Maintenance,
    TrainCar_TrackType: d.TrainCar_TrackType,
    TrainCar_EnergyType: d.TrainCar_EnergyType,
    TrainCar_MaxSpeed: d.TrainCar_MaxSpeed,
    TrainCar_Acceleration: d.TrainCar_Acceleration,
    TrainCar_Braking: d.TrainCar_Braking,
    TrainCar_Turning: d.TrainCar_Turning,
    TrainCar_BogieOffset: d.TrainCar_BogieOffset,
    TrainCar_AttachOffset: d.TrainCar_AttachOffset,
    MultipleUnitTrainCar_TrackType: d.MultipleUnitTrainCar_TrackType,
    MultipleUnitTrainCar_EnergyType: d.MultipleUnitTrainCar_EnergyType,
    MultipleUnitTrainCar_MaxSpeed: d.MultipleUnitTrainCar_MaxSpeed,
    MultipleUnitTrainCar_Acceleration: d.MultipleUnitTrainCar_Acceleration,
    MultipleUnitTrainCar_Braking: d.MultipleUnitTrainCar_Braking,
    MultipleUnitTrainCar_Turning: d.MultipleUnitTrainCar_Turning,
    MultipleUnitTrainCar_BogieOffset: d.MultipleUnitTrainCar_BogieOffset,
    MultipleUnitTrainCar_AttachOffset: d.MultipleUnitTrainCar_AttachOffset,
    MultipleUnitTrainFront_TrackType: d.MultipleUnitTrainFront_TrackType,
    MultipleUnitTrainFront_EnergyType: d.MultipleUnitTrainFront_EnergyType,
    MultipleUnitTrainFront_MaxSpeed: d.MultipleUnitTrainFront_MaxSpeed,
    MultipleUnitTrainFront_Acceleration: d.MultipleUnitTrainFront_Acceleration,
    MultipleUnitTrainFront_Braking: d.MultipleUnitTrainFront_Braking,
    ...
    Watercraft_Braking: d.Watercraft_Braking,
    Watercraft_Turning: d.Watercraft_Turning,
    Watercraft_AngularAcceleration: d.Watercraft_AngularAcceleration,
    Helicopter_Size: d.Helicopter_Size,
    Helicopter_GroundMaxSpeed: d.Helicopter_GroundMaxSpeed,
    Helicopter_GroundAcceleration: d.Helicopter_GroundAcceleration,
    Helicopter_GroundBraking: d.Helicopter_GroundBraking,
    ...
    Airplane_GroundMaxSpeed: d.Airplane_GroundMaxSpeed,
    Airplane_GroundAcceleration: d.Airplane_GroundAcceleration,
    Airplane_GroundBraking: d.Airplane_GroundBraking,
    Airplane_GroundTurning: d.Airplane_GroundTurning,
    Airplane_FlyingSpeed: d.Airplane_FlyingSpeed,
    Airplane_FlyingAcceleration: d.Airplane_FlyingAcceleration,
    Airplane_FlyingBraking: d.Airplane_FlyingBraking,
    Airplane_FlyingTurning: d.Airplane_FlyingTurning,
    Airplane_FlyingAngularAcceleration: d.Airplane_FlyingAngularAcceleration,
    Airplane_ClimbAngle: d.Airplane_ClimbAngle,
    Airplane_SlowPitchAngle: d.Airplane_SlowPitchAngle,
    Airplane_TurningRollFactor: d.Airplane_TurningRollFactor,
    Rocket_Size: d.Rocket_Size,
    Rocket_GroundMaxSpeed: d.Rocket_GroundMaxSpeed,
    Rocket_GroundAcceleration: d.Rocket_GroundAcceleration,
    Rocket_GroundBraking: d.Rocket_GroundBraking,
    Rocket_GroundTurning: d.Rocket_GroundTurning,
    Rocket_FlyingMaxSpeed: d.Rocket_FlyingMaxSpeed,
    Rocket_FlyingAcceleration: d.Rocket_FlyingAcceleration,
