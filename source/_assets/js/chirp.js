  ...
  setTimeout(async () => {
    ...
    if (last_updated_obj.getTime() > old_time) {
      ...
      if (chirpUserGender == 0) {
        firstName =
          (await getLangDataRandomly("Assets.CITIZEN_NAME_MALE")) || "StarQ";
        lastName =
          (await getLangDataRandomly("Assets.CITIZEN_SURNAME_MALE")) || "";
      } else {
        firstName =
          (await getLangDataRandomly("Assets.CITIZEN_NAME_FEMALE")) || "StarQ";
        lastName =
          (await getLangDataRandomly("Assets.CITIZEN_SURNAME_FEMALE")) || "";
      }
